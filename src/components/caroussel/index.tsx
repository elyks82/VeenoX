    ...
    >
      <div className="relative w-full">
        ...
        <div className="flex justify-end gap-2 mr-10">
          <button
            className="relative z-40 h-10 w-10 rounded-full bg-base_color flex items-center justify-center disabled:opacity-50"
            onClick={scrollLeft}
        ...
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto no-scrollbar ">
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="bg-[rgba(0,0,0,0.3)] opacity-30 h-full w-full fixed inset-0"
            />
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              ...
              className="max-w-[500px] mx-auto bg-white dark:bg-neutral-900 h-fit z-[60] my-10 p-4 md:p-10 rounded-3xl font-sans relative"
            >
              <button
              ...
              <motion.p
                ...
                className="text-base font-medium text-base_color"
              >
                {card.category}
              </motion.p>
              <motion.p
