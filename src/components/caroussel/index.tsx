    ...
    <>
        ...
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="bg-secondary backdrop-blur-lg h-full w-full fixed inset-0"
            />
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
      ...
      >
        ...
        <div className="relative z-40 p-8">
          ...
          {/* <motion.p className="text-font-60 text-lg mt-5 font-normal max-w-xs text-left [text-wrap:balance] font-sans">
            {card.description}
          </motion.p> */}
        </div>
        <BlurImage
